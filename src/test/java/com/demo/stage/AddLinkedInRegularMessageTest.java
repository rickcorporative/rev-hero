...
@Epic("Test Epic")
@Feature("Add LinkedIn regular message type stage")
@Owner("QA Yuliia Drapushko")
public class AddLinkedInRegularMessageTest extends BaseTest {
    ...
    public void addEmailTest() {
        ...
        Pages.navigationPage().markLinkedInRegularMessageCheckbox();
