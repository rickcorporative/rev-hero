...
@Epic("Test Epic")
@Feature("Add Send Pandadoc E-Signature type stage")
@Owner("QA Yuliia Drapushko")
public class AddSendPandadocSignatureTest extends BaseTest {

    @Test(description = "add Send Pandadoc E-Signature type stage test")
    public void addEmailTest() {
        ...
        Pages.navigationPage().markSendPandadocSignatureCheckbox();

        Pages.navigationPage().clickNextButton();

        Pages.navigationPage().clickSaveButton();

        Assert.assertTrue(!Pages.navigationPage().checkIfEmailStageCreated(), "Error! Send Pandadoc e-signature type stage was not added...");
